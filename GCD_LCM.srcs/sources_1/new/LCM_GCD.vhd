...
PORT( 
             ...
             XO_M : OUT std_logic_vector(15 DOWNTO 0));
...
signal X_LCM, X_GCD, Y_LCM, Y_GCD, X_MUX, Y_MUX, RX,RY : std_logic_vector(15 downto 0);
signal AR0,BR0 : std_logic_vector(15 downto 0);
...
REG_ABSELECT0 : REG_ABSELECT port map ( A_R => AF, B_R => BF, 
                A_RO => AR0 ,B_RO => BR0 ,  REG_ABSELECTLD => LDR0,
                CLR => CLR0 ,CLK => CLK0);
...
UC : UNIDAD_CONTROL port map (CLR => CLR0 ,CLK => CLK0, S_UC => SEL0, GO => GO0,
