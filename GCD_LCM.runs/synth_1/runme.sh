...
HD_PWD='C:/Users/Usuario/Desktop/2021-1/barbosa/GCD_LCM/GCD_LCM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LCM_GCD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LCM_GCD.tcl
